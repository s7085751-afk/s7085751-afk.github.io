...
In this course, I am learning how to write **bold** text, use _italics_ for emphasis, and even write `inline code` snippets.

- My GitHub Profile(https://github.com/s7085751-afk)
- MDN Web Docs - Useful Resource(https://developer.mozilla.org)
...
Problem solving
Designing UI
Check out my favourite website for inspiration: GitHub      
